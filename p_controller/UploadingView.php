            ...
            if (isset($tipeDok[1])) {
                ...
                if ($moveFiles) {
                    $saveDataFile = mysql_query("INSERT INTO tb_dokumen "
                        . "(id_staff, id_folder, nama_dok, nama_ori, jenis_dok, ukuran, jml_download, dok_create, dok_status) "
                        . "VALUES "
                        . "('$idStaff', '$idFolder', '$dest','$judul','$type','$size','0',now(),'1')");
                    if ($saveDataFile) {
                        ...
                        header("Location: ?p=myfile&folder=$idFolder");
                    } else {
